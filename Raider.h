...
// coder : Agha Talha
// purpose of code: This is the code for an enemy version RAIDERS (Weakest Type Enemies), the code is inherited from Enemy base Logic
